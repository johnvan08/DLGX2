 ...
 */
//@Table(name = "FenZhiXiangBean", onCreated = "CREATE UNIQUE INDEX index_fenzhixiang ON fenzhixiangbean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class FenZhiXiangBean {
    //主键id
