 ...
 */
public class HuanWangGuiNewsActivity extends Activity implements View.OnClickListener {
    ...
    public static HuanWangGuiNewsActivity HuanWangGuiNewsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentView = getLayoutInflater().inflate(R.layout.huanwangguinewsactivity_layout, null);
        setContentView(parentView);
        HuanWangGuiNewsActivity = this;
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_finish:
                if (click() == true) {
                    offlineSave();
                    if(bmp!=null){
                        pictureDatabase.saveHuangWangGuiPhoto(bmp);
                    }
                    if(bmp1!=null) {
                        pictureDatabase.saveHuangWangGuiPhoto(bmp1);
                    }
                    finish();
                    sendBroadcast(new Intent(AddSheBeiMapActivity.FINISH_ACTIVITY));
                    Toast.makeText(HuanWangGuiNewsActivity.this, "新增环网柜完成", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
    ...
    private Boolean click() {
        ...
        if (Fangwei.equals("")) {
            Toast.makeText(HuanWangGuiNewsActivity.this, "请输入设备名称", Toast.LENGTH_SHORT).show();
            return false;
        }
...
//                .singleSelect()
        ...
        ImageSelector.open(HuanWangGuiNewsActivity, imageConfig);   // 开启图片选择器
    }
...
//                    ArrayList<Bitmap>  bitmap_list = pictureDatabase.getHuangWangGuiDrawable();
//                    if ( bitmap_list != null) {
//                        Iterator<Bitmap> iterator =  bitmap_list.iterator();
//                        while (iterator.hasNext()) {
//                            Bitmap a = iterator.next();
//                            // addressDB.updeteAddress(a);
//                            pictureDatabase.updeteHuangWangGuiPhoto(a);
//                        }
//                    }
