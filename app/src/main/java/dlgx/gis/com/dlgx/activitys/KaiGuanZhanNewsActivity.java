 ...
 */
public class KaiGuanZhanNewsActivity extends Activity implements View.OnClickListener {
    ...
    public static KaiGuanZhanNewsActivity KaiGuanZhanNewsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kaiguanzhannewsactivity_layout);
        ButterKnife.bind(this);
        KaiGuanZhanNewsActivity = this;
        initView();
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_finish:
                if (click() == true) {
                    offlineSave();
                    if(bmp!=null){
                        pictureDatabase.saveKaiGuanZhanPhoto(bmp);
                    }
                    if(bmp1!=null) {
                        pictureDatabase.saveKaiGuanZhanPhoto(bmp1);
                    }
                    finish();
                    sendBroadcast(new Intent(AddSheBeiMapActivity.FINISH_ACTIVITY));
                    Toast.makeText(KaiGuanZhanNewsActivity.this, "新增开关站完成", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
    ...
    private Boolean click() {
        ...
        if (Fangwei.equals("")) {
            Toast.makeText(KaiGuanZhanNewsActivity.this, "请输入设备名称", Toast.LENGTH_SHORT).show();
            return false;
        }
...
//                .singleSelect()
        ...
        ImageSelector.open(KaiGuanZhanNewsActivity, imageConfig);   // 开启图片选择器
    }
