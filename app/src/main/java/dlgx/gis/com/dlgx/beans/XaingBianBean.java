 ...
 */
//@Table(name = "XaingBianBean", onCreated = "CREATE UNIQUE INDEX index_xaingbian ON xaingbianbean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class XaingBianBean {
