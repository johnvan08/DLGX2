 ...
 */
//@Table(name = "GanTaBean ", onCreated = "CREATE UNIQUE INDEX index_ganta ON gantabean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class GanTaBean {
    //主键id
