 ...
 */
//@Table(name = "PeiDinshiBean", onCreated = "CREATE UNIQUE INDEX index_peidinshi ON peidinshibean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class PeiDinshiBean {
    //主键id
