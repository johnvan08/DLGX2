 ...
 */
//@Table(name = "BianYaQiBean", onCreated = "CREATE UNIQUE INDEX index_bianyaqi ON bianyaqibean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class BianYaQiBean {
    //主键id
