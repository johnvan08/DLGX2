 ...
 */
public class PeiDianShiNewsActivity extends Activity implements View.OnClickListener {
    ...
    public static PeiDianShiNewsActivity PeiDianShiNewsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentView = getLayoutInflater().inflate(R.layout.peidianshinewsactivity_layout, null);
        setContentView(parentView);
        PeiDianShiNewsActivity = this;
        ButterKnife.bind(this);
        initView();
        pictureDatabase = new PictureDatabase(PeiDianShiNewsActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_finish:
                if (click() == true) {
                    if(bmp!=null){
                        pictureDatabase.savePeiDainShiPhoto(bmp);
                    }
                    if(bmp1!=null) {
                        pictureDatabase.savePeiDainShiPhoto(bmp1);
                    }
                    offlineSave();
                    finish();
                    sendBroadcast(new Intent(AddSheBeiMapActivity.FINISH_ACTIVITY));
                    Toast.makeText(PeiDianShiNewsActivity.this, "新增配电室完成", Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    private Boolean click() {
        ...
        if (Fangwei.equals("")) {
            Toast.makeText(PeiDianShiNewsActivity.this, "请输入设备名称", Toast.LENGTH_SHORT).show();
            return false;
        }
...
//                .singleSelect()
        ...
        ImageSelector.open(PeiDianShiNewsActivity, imageConfig);   // 开启图片选择器
    }
