 ...
 */
//@Table(name = "YanMaiJingBean", onCreated = "CREATE UNIQUE INDEX index_yanmaijing ON yanmaijingbean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class YanMaiJingBean {
    //主键id
