 ...
 */
public class XiangBianNewsActivity extends Activity implements View.OnClickListener {
    ...
    public static XiangBianNewsActivity XiangBianNewsActivity;
    private PictureDatabase pictureDatabase;
    private Bitmap bmp,bmp1;
    private String equipmentType;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.xiangbiannewsactivity_layout);
        XiangBianNewsActivity = this;
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_finish:
                if (click() == true) {
                    offlineSave();
                    if(bmp!=null){
                        pictureDatabase.saveXiangBianPhoto(bmp);
                    }
                    if(bmp1!=null) {
                        pictureDatabase.saveXiangBianPhoto(bmp1);
                    }
                    finish();
                    sendBroadcast(new Intent(AddSheBeiMapActivity.FINISH_ACTIVITY));
                    Toast.makeText(XiangBianNewsActivity.this, "新增箱变完成", Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    private Boolean click() {
        ...
        if (Fangwei.equals("")) {
            Toast.makeText(XiangBianNewsActivity.this, "请输入设备名称", Toast.LENGTH_SHORT).show();
            return false;
        }
...
//                .singleSelect()
        ...
        ImageSelector.open(XiangBianNewsActivity, imageConfig);   // 开启图片选择器
    }
