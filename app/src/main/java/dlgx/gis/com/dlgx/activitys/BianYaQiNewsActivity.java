...
import dlgx.gis.com.dlgx.beans.Add;
...
//import com.example.admin.myapplication.activities.db.BianYaQiDB;

/**
 * 新增设备-变压器信息
 * Created by admin on 2017/4/28.
 */
public class BianYaQiNewsActivity extends Activity implements View.OnClickListener {
    ...
    public static BianYaQiNewsActivity BianYaQiNewsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentView = getLayoutInflater().inflate(R.layout.bianyaqinewsactivity_layout, null);
        setContentView(parentView);
        ButterKnife.bind(this);
        BianYaQiNewsActivity = this;
        initView();
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_finish:
                if (click() == true) {
                    ...
                    Toast.makeText(BianYaQiNewsActivity.this, "新增变压器完成", Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    private Boolean click() {
        ...
        if (Fangwei.equals("")) {
            Toast.makeText(BianYaQiNewsActivity.this, "请输入设备名称", Toast.LENGTH_SHORT).show();
            return false;
        }
...
//        BianYaQiDB addressDB =   BianYaQiDB.getInstance(getBaseContext());
//        addressDB.insertAddress(beans);
        // 向数据库中插入指定数据
...
//                .singleSelect()
        ...
        ImageSelector.open(BianYaQiNewsActivity, imageConfig);   // 开启图片选择器
    }
