 ...
 */
//@Table(name = "KaiGuanZhanBean", onCreated = "CREATE UNIQUE INDEX index_kaiguanzhan ON kaiguanzhanbean(uuid,name,maishen,jingdu,weidu,image,beizhu,zuoyedanwei,xinznegshijian)")
public class KaiGuanZhanBean {
    //主键id
